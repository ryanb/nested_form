...
This fork modifies the formbuilder to work with twitter bootstrap, assuming you are using the formtastic bootstrap gem (https://github.com/mjbellantoni/formtastic-bootstrap)
