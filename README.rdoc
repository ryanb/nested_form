...
== SimpleForm, Formtastic and {Turkee}[http://www.github.com/aantix/turkee] Support

Use <tt>simple_nested_form_for</tt>, <tt>semantic_nested_form_for</tt>, or <tt>turkee_nested_form_for</tt> for SimpleForm, Formtastic or Turkee support respectively. This is feature is not yet in a Gem release but is in the Git repo.
...
nested_form uses appraisal to manage rails dependencies (cause we need to test it with different rails versions), so, in order to run tests you should do this:
