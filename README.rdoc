...
This plugin has been tested to work with a Rails 3 app.

Read this blog post to learn about how this plugin works under the hood http://blog.madebydna.com/dynamic-nested-forms-in-rails-3-with-the-nest

== Install

This is currently only available as a plugin.

  rails plugin install git://github.com/madebydna/nested_form.git
...
This plugin is a fork of the solution by Ryan Bates: http://github.com/ryanb/nested_form
